...
**Статус на 18.08.2026:** Этап 1 и Этап 2 закрыты. Этап 2 («Курсы и лекции») переименован в «Учебные курсы» и
сокращён до `Course` (✅ issue #29) — `Lecture` и решение по правам доступа (issue #31) перенесены в новый
Этап 4, который теперь стоит после Этапа 3 «Циклическое расписание» (`StudyYear`/`Semester`/`Group`/
`WeekScheduleCycle`), зафиксированного в `TARGET.md`. Этап «Зачисление и посещаемость» сдвинут на 5, «Прод-
готовность» — на 6.
